  ...
  public: {
    Tables: {
      ...
      waitlist_entries: {
        Row: {
          ...
          decision_notified_for: "approved" | "rejected" | null;
          email: string;
          full_name: string;
          id: string;
      ...
      qa_questions: {
        Row: {
          ...
          id: string;
          moderation_state: "passed" | "blocked";
    ...
    Functions: {
      ...
      admin_review_waitlist: {
        Args: { _admin_note?: string | null; _entry_id: string; _status: string };
      ...
      admin_replace_moderation_domains: {
        Args: { _category: string; _domains: string[]; _source: string; _source_url: string };
        Returns: number;
      };
      match_member_profiles: {
        Args: { match_count?: number; query_embedding: string; query_text: string };
        Returns: { profile_id: string; score: number }[];
      };
